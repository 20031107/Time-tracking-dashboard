...
function forWorkDaily(data) {
    if (data[0].title === 'Work') {
      workHours.innerText = `${data[0].timeframes.daily.previous}`;
  ...
  function forWorkWeekly(data) {
    if (data[0].title === 'Work') {
      workHours.innerText = `${data[0].timeframes.weekly.previous}`;
  ...
  function forWorkMonthly(data) {
    if (data[0].title === 'Work') {
      workHours.innerText = `${data[0].timeframes.monthly.previous}`;
  ...
  function forPlayDaily(data) {
    if (data[1].title === 'Play') {
      playHours.innerText = `${data[1].timeframes.daily.previous}`;
  ...
  function forPlayWeekly(data) {
    if (data[1].title === 'Play') {
      playHours.innerText = `${data[1].timeframes.weekly.previous}`;
  ...
  function forPlayMonthly(data) {
    if (data[1].title === 'Play') {
      playHours.innerText = `${data[1].timeframes.monthly.previous}`;
    ...
    function forStudyDaily(data) {
      if (data[2].title === 'Study') {
        studyHours.innerText = `${data[2].timeframes.daily.previous}`;
    ...
    function forStudyWeekly(data) {
      if (data[2].title === 'Study') {
        studyHours.innerText = `${data[2].timeframes.weekly.previous}`;
    ...
    function forStudyMonthly(data) {
      if (data[2].title === 'Study') {
        studyHours.innerText = `${data[2].timeframes.monthly.previous}`;
    ...
    function forExerciseDaily(data) {
      if (data[3].title === 'Exercise') {
        exerciseHours.innerText = `${data[3].timeframes.daily.previous}`;
    ...
    function forExerciseWeekly(data) {
      if (data[3].title === 'Exercise') {
        exerciseHours.innerText = `${data[3].timeframes.weekly.previous}`;
    ...
    function forExerciseMonthly(data) {
      if (data[3].title === 'Exercise') {
        exerciseHours.innerText = `${data[3].timeframes.monthly.previous}`;
    ...
    function forSocialDaily(data) {
      if (data[4].title === 'Social') {
        socialHours.innerText = `${data[4].timeframes.daily.previous}`;
    ...
    function forSocialWeekly(data) {
      if (data[4].title === 'Social') {
        socialHours.innerText = `${data[4].timeframes.weekly.previous}`;
    ...
    function forSocialMonthly(data) {
      if (data[4].title === 'Social') {
        socialHours.innerText = `${data[4].timeframes.monthly.previous}`;
    ...
    function forCareDaily(data) {
      if (data[5].title === 'Self Care') {
        careHours.innerText = `${data[5].timeframes.daily.previous}`;
    ...
    function forCareWeekly(data) {
      if (data[5].title === 'Self Care') {
        careHours.innerText = `${data[5].timeframes.weekly.previous}`;
    ...
    function forCareMonthly(data) {
      if (data[5].title === 'Self Care') {
        careHours.innerText = `${data[5].timeframes.monthly.previous}`;
